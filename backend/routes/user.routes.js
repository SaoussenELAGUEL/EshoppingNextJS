...
var transporter =nodemailer.createTransport({
    service:'gmail',
    auth:{
        user:'esps.formation@gmail.com',
        pass:'ydynbheusyaxtpdh'
    },
    tls:{
...
var mailOption ={
    from: '"verify your email " <esps.formation@gmail.com>',
    to: newUser.email,
    ...
    return res.status(201).send({ success: true, message: "Account created successfully", user: createdUser })} catch (err) {
    console.log(err)
